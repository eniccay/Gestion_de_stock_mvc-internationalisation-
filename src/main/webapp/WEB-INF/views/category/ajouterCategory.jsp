	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"><fmt:message code="common.nouveau.category" /></h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
                <div class="col-lg-12">
					...
					<fmt:message code="category.formulaire"/>
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <c:url value="/category/enregistrer" var ="urlEnreister"/>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label> <fmt:message  code="category.designiation" /></label>
